...
('The Girl with the Dragon','Stieg Larsson','2005','Mystery','A journalist and hacker investigate a woman’s disappearance, uncovering dark secrets.')
('Gone Girl','Gillian Flynn','2012','Mystery','A psychological thriller about a wife’s disappearance and the twisted media frenzy that follows.')
...
('To Kill a Mockingbird','Harper Lee','1960','Drama','A powerful look at racism and justice through a child’s eyes in the American South.')
...
('The Kite Runner','Khaled Hossein','Drama','A story of friendship and redemption set against the backdrop of a changing Afghanistan.')
('Atomic Habits	','James Clear	','2018','Self-Help / Productivity','A guide to building good habits and breaking bad ones with practical strategies.')
...
('The Subtle Art of Not Giving a Fck*','Mark Manson','2016','Self-Help','A counterintuitive guide to living a better life by caring less about what doesn’t matter.')
